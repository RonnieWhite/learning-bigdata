package com.baich.learning_bigdata.learning_hadoop.actual.jd_order_analysis.mr;

import com.baich.learning_bigdata.learning_hadoop.actual.jd_order_analysis.mrbean.WebLogBean;
    ...
    static class ClickStreamMapper extends Mapper<LongWritable, Text, Text, WebLogBean> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (v.isValid()) {
                ...
                context.write(k, v); // ip地址作为key，写入reduce中
            }
        }
    }
...
//        FileInputFormat.setInputPaths(job, new Path("E:/data/webLog/operate/three/input/part-m-00000"));
        FileOutputFormat.setOutputPath(job, new Path(args[1]));
//        FileOutputFormat.setOutputPath(job, new Path("E:/data/webLog/operate/three/output"));
